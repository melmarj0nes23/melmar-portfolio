          ...
          <div className="absolute inset-0 bg-black/75 flex items-center justify-center p-4 z-40">
            <form onSubmit={handleSaveCover} className="bg-white rounded-lg p-4 font-sans max-w-md w-full shadow-2xl text-gray-900 border border-gray-300">
              ...
              <input
                ...
                className="w-full text-xs p-2 border border-gray-350 rounded mb-3 font-sans focus:outline-blue-500 text-gray-900"
              ...
              <div className="flex justify-end gap-2 text-xs">
                ...
                <button
                  type="submit"
                  className="px-3 py-1.5 bg-[#1877f2] hover:bg-[#166fe5] text-white rounded font-semibold"
                >
                  Save Cover
                </button>
              </div>
      ...
      <div className="relative px-6 pb-4 pt-1 flex flex-col md:flex-row items-center md:items-end justify-between border-b border-gray-200">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-end gap-4 -mt-24 md:-mt-16 z-10 w-full md:w-auto">
              ...
              <div className="fixed inset-0 bg-black/70 flex items-center justify-center p-4 z-50">
                <form onSubmit={handleSaveAvatar} className="bg-white rounded-lg p-4 font-sans max-w-sm w-full shadow-2xl border border-gray-300">
                  ...
                  <input
                    ...
                    className="w-full text-xs p-2 border border-gray-350 rounded mb-3 font-sand focus:outline-blue-500 text-gray-900"
          ...
          <div className="text-center md:text-left mb-2">
              ...
              {isEditingName ? (
                <div className="flex items-center gap-1">
                  <input
                    ...
                    className="text-2xl md:text-3xl font-bold font-sans text-gray-900 border-b-2 border-[#1877f2] focus:outline-none"
                    maxLength={30}
                    autoFocus
                  />
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-x-2 gap-y-1 text-xs text-gray-400 font-sans mt-1">
              ...
              <span>•</span>
              <a href={profile.github} target="_blank" rel="noopener noreferrer" className="hover:underline flex items-center gap-0.5 text-blue-600 font-medium">
                GitHub <ArrowUpRight className="w-3 h-3" />
              </a>
              <span>•</span>
              <a href={profile.linkedin} target="_blank" rel="noopener noreferrer" className="hover:underline flex items-center gap-0.5 text-blue-600 font-medium">
                LinkedIn <ArrowUpRight className="w-3 h-3" />
              </a>
              {profile.facebook && (
                <>
                  <span>•</span>
                  <a href={profile.facebook} target="_blank" rel="noopener noreferrer" className="hover:underline flex items-center gap-0.5 text-blue-600 font-medium">
              ...
              {profile.email && (
                <>
                  <span>•</span>
                  <a href={profile.email} className="hover:underline flex items-center gap-0.5 text-blue-600 font-medium">
        ...
        <div className="flex items-center gap-2 mt-4 md:mt-0 z-30 relative" ref={menuRef}>
          <a
            ...
            className="px-4 py-2 bg-[#1877f2] hover:bg-[#166fe5] text-white font-semibold text-sm rounded shadow transition-colors flex items-center gap-1.5"
            id="fb-connect-btn"
          >
            <span>Connect</span>
          </a>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex justify-end gap-2">
                ...
                <button
                  ...
                  className="px-2.5 py-1 text-xs text-white bg-[#1877f2] hover:bg-[#166fe5] rounded transition-colors"
                >
                  Save
                </button>
              </div>
